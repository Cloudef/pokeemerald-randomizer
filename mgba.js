var mGBA = (function () {
   ...
   return function (mGBA) {
      ...
      var wasmMemory;
      var wasmTable = new WebAssembly.Table({ initial: 4916, maximum: 4916, element: 'anyfunc' });
      var ABORT = false;
      var EXITSTATUS = 0;
      ...
      var Browser = {
         ...
         init: function () {
            ...
            audioPlugin['canHandle'] = function audioPlugin_canHandle(name) {
               return (
                  !Module.noAudioDecoding && name.substr(-4) in { '.ogg': 1, '.wav': 1, '.mp3': 1 }
               );
            };
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = mGBA;
